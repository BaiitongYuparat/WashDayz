...
export const UserHeader = ({user}: UserHeader) => {
    return(
        <View className=" p-4 flex-row items-center bg-white shadow-md shadow-gray-300">
            ...
            <View className="flex-1 ml-4">
                <Text className="font-bold text-blue-main text-xl">{user.name} {user.surname}</Text>
                <Text className="text-gray-300">{user.address}</Text>
            </View>
        </View>
    )
}